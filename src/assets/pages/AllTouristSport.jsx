...
const AllTouristSport = () => {
    ...
    return (
        <section className="dark:bg-gray-100 dark:text-gray-800 ">
            ...
            <div className="relative p-6  md:h-48 dark:bg-violet-600 dark:text-gray-50 bg-cover bg-no-repeat bg-[url('https://i.ibb.co.com/f0sgsW8/Blue-Orange-Aesthetic-Typography-Piano-Covers-Mix-Playlist-Music-Thumbnail-1.png')] ">
                ...
                <div className="absolute md:top-[165px] md:left-[680px] flex justify-center  p-3 items-center gap-3 max-sm:w-[90%] md:w-[550px] md:h-14 bg-white shadow-xl">
                ...
                <div className="relative lg:w-[33.33%]">
                    <div className=" sticky top-0 p-6">
                        ...
                        <div className="p-5 shadow-md mt-5">
                            <div className="">
                                <div className="divider divider-start"><span className="md:text-xl font-bold bg-gray-50 border border-gray-200 text-black md:px-5 py-2 ">Popular Tags</span></div>
                            </div>
                            <div className="space-y-3 pt-5 max-sm:space-y-2 ">
                                <div className="space-x-1 max-sm:space-y-2">
                        ...
                        <div className="px-3 py-5 shadow-md mt-4">
                            <div>
                                <div className="divider divider-start"><span className="md:text-xl font-bold bg-gray-50 border border-gray-200 text-black md:px-5 py-2 ">Weekend Getaways</span></div>
                            </div>
                            <div className="flex justify-start pt-4 hover:text-[#005294]">
                                <div className="md:w-20 md:text-2xl font-bold text-[#d60d45]">
                                    <h1>01</h1>
                                </div>

                                <Link>
                                    <h1 className="md:text-xl font-medium"> Weekend Getaways Near New York City</h1>
                                    <div className="md:flex text-[11px] gap-2 mt-1">
                            ...
                            <hr className="my-2" />
                            <div className="md:flex justify-start  pt-3 hover:text-[#005294]">
                                <div className="md:w-20 md:text-2xl font-bold text-[#d60d45]">
                                    <h1>02</h1>
                                </div>

                                <Link>
                                    <h1 className="md:text-xl font-medium">A Cultural Escape to Santa Fe, New Mexico</h1>
                                    <div className="md:flex text-[11px] gap-2 mt-1">
                            ...
                            <div className="md:flex justify-start  pt-3 hover:text-[#005294]">
                                ...
                                <Link>
                                    <h1 className="md:text-xl  font-medium"> A Tranquil Weekend in the Lake District, UK</h1>
                                    <div className="md:flex text-[11px] gap-2 mt-1">
                            ...
                            <div className="md:flex justify-start  pt-3 hover:text-[#005294]">
                                ...
                                <Link>
                                    <h1 className="md:text-xl  font-medium "> Romantic Getaways: Exploring Napa Valley Wineries</h1>
                                    <div className="md:flex text-[11px] gap-2 mt-1">
