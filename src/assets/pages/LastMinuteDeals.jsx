...
const LastMinuteDeals = () => {
    ...
    return (
        <>
            <section className="my-52 max-w-7xl mx-auto ">
                ...
                >
                    ...
                    <SwiperSlide>
                        ...
                        <div
                            className={`p-6 rounded-md shadow-md dark:bg-gray-50 dark:text-gray-900 bg-white transform transition-transform duration-300 cursor-pointer ${isZoomed ? "scale-110" : "scale-100"
                                }`} // Apply transform based on zoom state
                            onClick={handleSlideClick} // Handle click to trigger zoom
                        >
                            <img src="https://i.ibb.co/yFxQ28v/close-up-man-smiling-nature-23-2150771119.jpg" alt="" className="object-cover object-center w-full rounded-md h-72 dark:bg-gray-500" />
